...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname htdp-exercise-7-1-3) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define (area a-shape)
  (cond ((square? a-shape) (* (square-length a-shape)
