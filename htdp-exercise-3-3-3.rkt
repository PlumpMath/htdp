...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname htdp-exercise-3-3-3) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
(define (square x)
  (* x x))
