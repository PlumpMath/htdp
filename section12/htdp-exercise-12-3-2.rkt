...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname htdp-exercise-12-3-2) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.rkt" "teachpack" "htdp")))))
...
(define (connect-dots a-poly last-p)
  (cond
    ((empty? (rest a-poly))
