...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname htdp-exercise-7-4-6) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.rkt" "teachpack" "htdp")))))
...
(draw-shape
 (move-shape 10
             (move-shape 10
                         (move-shape 10
                                     (move-shape 10 my-rectangle)))))
(draw-shape
 (move-shape 10
             (move-shape 10
                         (move-shape 10
                                     (move-shape 10 my-circle)))))
