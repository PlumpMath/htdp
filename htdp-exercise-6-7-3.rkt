...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname htdp-exercise-6-7-3) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp") (lib "hangman.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.rkt" "teachpack" "htdp") (lib "hangman.rkt" "teachpack" "htdp")))))
...
(define (reveal target current guess)
  (make-word (check-c (word-c1 target) (word-c1 current) guess)
             (check-c (word-c2 target) (word-c2 current) guess)
             (check-c (word-c3 target) (word-c3 current) guess)))
