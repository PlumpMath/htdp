...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname htdp-exercise-16-3-4) (read-case-sensitive #t) (teachpacks ((lib "dir.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "dir.rkt" "teachpack" "htdp")))))
#| 파일
파일은 다음 구조체다.
...
(find? D2 'easyprinttoolbox_v120eng1.bak)
(find? D2 'easyprinttoolbox_v120eng1.exe)
(find? D3 '설치안내0523.bak)
(find? D3 '설치안내0523.hwp)
(find? D44 'hung)
(find? D44 'hang)
(find? D44 'read!)
