...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname htdp-exercise-16-3-2) (read-case-sensitive #t) (teachpacks ((lib "dir.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "dir.rkt" "teachpack" "htdp")))))
#| 파일
파일은 다음 구조체다.
...
;; 정의와 템플릿에 따라 논리적으로 작성하였으므로 올바른 결과를 출력할 것이라고 신뢰할 수 있다.
