...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname htdp-exercise-14-4-3) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(evaluate-expression (make-add (make-mul 20 3) 33))
(evaluate-expression (make-mul 3.14 (make-mul r r)))
(evaluate-expression (make-add (make-mul 9/5 c) 32))
(evaluate-expression (make-add (make-mul 3.14 (make-mul o o)) (make-mul 3.14 (make-mul i i))))
