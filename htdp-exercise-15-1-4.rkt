...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname htdp-exercise-15-1-4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ())))
...
(define (eye-colors a-parent)
  (cons (parent-eyes a-parent)
        (eye-colors-of-children (parent-children a-parent))))

(define (eye-colors-of-children a-loc)
  (cond ((empty? a-loc) empty)
        (else (append (eye-colors (first a-loc))
                      (eye-colors-of-children (rest a-loc))))))
